package com.nitrogen.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String NITROGEN = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, NITROGEN, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, NITROGEN, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(NITROGEN, "interval");
            if(newInterval != null)
